...
include "../../Modelo/Conexion.php";
    ...
    if($conductor == 'conductor' || $conductor == 'externo') { 
        ...
        GROUP BY conductores.id_conductor, conductores.nombre_conductor, zona2.valor_zona,registros.fecha,registros.fecha_despacho";
        ...
        WHERE ayudantes.cod_almacen = '$cod_almacen' and  registros.fecha_despacho BETWEEN '$desde' AND '$hasta'
            AND nombre_rol = '$conductor' and estado = 'entregado'
        GROUP BY ayudantes.id_conductor, ayudantes.nombre_conductor, zona2.valor_zona";
...
$pdf->Setfont('Arial','',9);
$pdf->SetWidths(array(30,30,35,35,35,35,32,34));
while($mostrar= mysqli_fetch_array($respuesta)){
    ...
    $pdf->Row(array(
        ...
        $mostrar['zona'],
        $mostrar['carga'],
        number_format($mostrar['total_pagar'], 2),
        $mostrar['fecha_registro'],
        $mostrar['fecha_salida']), 30);
