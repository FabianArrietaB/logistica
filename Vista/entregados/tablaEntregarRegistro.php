    ...
    $sql="SELECT
            ...
            FROM
                ...
                carga AS carga ON registros.id_carga = carga.id_carga
                    WHERE	estado ='entregado'  AND registros.cod_almacen ='$bodega'";
    $respuesta = mysqli_query($conexion, $sql);
?>
<table class="table table-sm  dt-responsive nowrap" id="tablaEntregarRegistroDataTable" style="width:100%">
<thead>
    <th>#</th>
    <th>cod_almacen</th> 
   <th>Fecha</th>
        ...
        <td><?php 
            ...
            ?>
             <button class="btn btn-warning btn-sm"
                    data-toggle="modal" data-target="#modalConfirmarEntrega"
                    onclick="obtenerConfirmacionEntrega(<?php echo $mostrar['idRegistro']?>)">
...
<script>
    $(document).ready(function(){
        $('#tablaEntregarRegistroDataTable').DataTable({
            "language": {
