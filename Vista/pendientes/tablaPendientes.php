    ...
    $sql="SELECT
            ...
            FROM
                ...
                carga AS carga ON registros.id_carga = carga.id_carga
                    WHERE	estado ='entregado' AND estado_entrega ='entregado con pendiente'  AND registros.cod_almacen ='$bodega'";
    $respuesta = mysqli_query($conexion, $sql);
?>
<table class="table table-sm  dt-responsive nowrap" id="tablaEnviarPendientesDataTable" style="width:100%">
<thead>
    <th>#</th>
    <th>cod_almacen</th> 
   <th>Fecha</th>
   ...
   <th>observacion</th>
    ...
    <tr>
        ...
        <td><?php echo $mostrar['observacion'];?>
            <button class="btn btn-warning btn-sm"
                    onclick="reenviarDocumentos(<?php echo $mostrar['idRegistro']?>)">
...
<script>
    $(document).ready(function(){
        $('#tablaEnviarPendientesDataTable').DataTable();
    });
</script>